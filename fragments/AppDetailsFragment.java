...
public class AppDetailsFragment extends Fragment {
    ...
    static DataServices.App appChosen;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter(getActivity(), android.R.layout.simple_list_item_1, android.R.id.text1, appChosen.genres);
        binding.genreListView.setAdapter(adapter);
        binding.appNameDetails.setText(appChosen.name);
        binding.artistNameDetails.setText(appChosen.artistName);
        binding.releaseDateDetails.setText(appChosen.releaseDate);
    }

    public static void appClickedOn(DataServices.App chosenApp){
        appChosen = chosenApp;
    }
}